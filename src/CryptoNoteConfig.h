...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x2181;
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(338000338000338);
...
const char     CRYPTONOTE_NAME[]                             = "nereid";
...
const int      P2P_DEFAULT_PORT                              = 33899;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 33800;
